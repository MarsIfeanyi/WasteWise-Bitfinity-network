...
const ChartOne: React.FC = () => {
  ...
  return (
    <div className="col-span-12 border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-0 dark:shadow-md dark:bg-base-300 rounded-xl sm:px-7.5 xl:col-span-8">
